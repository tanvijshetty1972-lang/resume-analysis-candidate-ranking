...
4. **AI Score** is computed and displayed along with **recommendations**
5. Interactive **dashboard** shows charts for easy interpretation
...
1. `pdfplumber` documentation: [https://github.com/jsvine/pdfplumber](https://github.com/jsvine/pdfplumber)
